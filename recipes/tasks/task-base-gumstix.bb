...
#
# task-base-gumstix contain stuff needed for base system (machine related)
#
...
RDEPENDS_task-base-gumstix-extended = "\
    task-base-gumstix \
    ${ADD_WIFI} \
    ${ADD_BT} \
    "
...
python __anonymous () {
    ...
    # then include task-base-wifi in task-base-gumstix
...
RRECOMMENDS_task-base-touchscreen = "\
